...
For each boundary condition there $5$ values neede. The total number of boundary conditions is $bondnum$. The boundary conditions are all of the following general form:
